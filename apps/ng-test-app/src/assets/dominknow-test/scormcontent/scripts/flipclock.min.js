...
d;f.toString=this.toString;f.valueOf=function(a){return"object"==a?f:e.valueOf()};b.call(f,a);"function"==typeof f.init&&f.init();return f};
...
h=["constructor","toString","valueOf"],k=Base._prototyping?0:1;g=h[k++];)c[g]!=f[g]&&e.call(this,g,c[g]);for(var g in c)f[g]||e.call(this,g,c[g])}return this}};
...
(function(c){FlipClock=function(a,b,d){b instanceof Object&&!1===b instanceof Date&&(d=b,b=0);return new FlipClock.Factory(a,b,d)};FlipClock.Lang={};FlipClock.Base=Base.extend({buildDate:"2014-12-12",version:"0.7.7",constructor:function(a,b){"object"!==typeof a&&(a={});"object"!==typeof b&&(b={});this.setOptions(c.extend(!0,{},a,b))},callback:function(a){if("function"===typeof a){for(var b=[],d=1;d<=arguments.length;d++)arguments[d]&&b.push(arguments[d]);a.apply(this,b)}},log:function(a){},getOption:function(a){return this[a]?
this[a]:!1},getOptions:function(){return this},setOption:function(a,b){this[a]=b},setOptions:function(a){for(var b in a)"undefined"!==typeof a[b]&&this.setOption(b,a[b])}})})(jQuery);
(function(c){FlipClock.Face=FlipClock.Base.extend({autoStart:!0,dividers:[],factory:!1,lists:[],constructor:function(a,b){this.dividers=[];this.lists=[];this.base(b);this.factory=a},build:function(){this.autoStart&&this.start()},createDivider:function(a,b,d){"boolean"!=typeof b&&b||(d=b,b=a);var e=['\x3cspan class\x3d"'+this.factory.classes.dot+' top"\x3e\x3c/span\x3e','\x3cspan class\x3d"'+this.factory.classes.dot+' bottom"\x3e\x3c/span\x3e'].join("");d&&(e="");a=this.factory.localize(a);a=['\x3cspan class\x3d"'+
this.factory.classes.divider+" "+(b?b:"").toLowerCase()+'"\x3e','\x3cspan class\x3d"'+this.factory.classes.label+'"\x3e'+(a?a:"")+"\x3c/span\x3e",e,"\x3c/span\x3e"];a=c(a.join(""));this.dividers.push(a);return a},createList:function(a,b){"object"===typeof a&&(b=a,a=0);a=new FlipClock.List(this.factory,a,b);this.lists.push(a);return a},reset:function(){var a=this.factory.original?Math.round(this.factory.original):0;this.factory.time=new FlipClock.Time(this.factory,a,{minimumDigits:this.factory.minimumDigits});
this.flip(!1,!1);this.factory.time.time=a},appendDigitToClock:function(a){a.$el.append(!1)},addDigit:function(a){a=this.createList(a,{classes:{active:this.factory.classes.active,before:this.factory.classes.before,flip:this.factory.classes.flip}});this.appendDigitToClock(a)},start:function(){},stop:function(){},autoIncrement:function(){this.factory.countdown?this.decrement():this.increment()},increment:function(){this.factory.time.addSecond()},decrement:function(){0==this.factory.time.getTimeSeconds()?
this.factory.stop():this.factory.time.subSecond()},flip:function(a,b){var d=this;c.each(a,function(a,c){(a=d.lists[a])?(b||c==a.digit||a.play(),a.select(c)):d.addDigit(c)})}})})(jQuery);
...
b,d,c){var f=!1;a=a.ucfirst()+"Face";this.face.stop&&(this.stop(null,d),f=!0);this.$el.html("");this.time.minimumDigits=this.minimumDigits;a=FlipClock[a]?new FlipClock[a](this,b):new FlipClock[this.defaultClockFace+"Face"](this,b);a.build();this.face=a;f&&!c&&this.start(null,!0);return this.face},loadLanguage:function(a){return this.lang=FlipClock.Lang[a.ucfirst()]?FlipClock.Lang[a.ucfirst()]:FlipClock.Lang[a]?FlipClock.Lang[a]:FlipClock.Lang[this.defaultLanguage]},localize:function(a,b){var d=this.lang;
if(!a)return null;var c=a.toLowerCase();"object"==typeof b&&(d=b);return d&&d[c]?d[c]:a},start:function(a,b){var d=this;d.running||d.countdown&&!(d.countdown&&0<d.time.time)?d.log("Trying to start timer when countdown already at 0"):(d.face.start(d.time),d.timer.start(function(){d.flip();"function"===typeof a&&a()},b))},stop:function(a,b){this.face.stop();this.timer.stop(a,b);for(var d in this.lists)this.lists.hasOwnProperty(d)&&this.lists[d].stop()},reset:function(a){var b=this;this.timer.reset(this.running?
function(){b.flip();"function"===typeof a&&a()}:null);this.face.reset()},setTime:function(a){this.time.time=a;this.flip(!0);this.time.time=a},getTime:function(a){return this.time},setCountdown:function(a){var b=this.running;this.countdown=a?!0:!1;b&&(this.stop(),this.start())},flip:function(a){this.face.flip(!1,a)}})})(jQuery);
...
(function(c){FlipClock.Timer=FlipClock.Base.extend({callbacks:{destroy:!1,create:!1,init:!1,interval:!1,start:!1,stop:!1,reset:!1},count:0,factory:!1,interval:1E3,animationRate:1E3,constructor:function(a,b){this.base(b);this.factory=a;this.callback(this.callbacks.init);this.callback(this.callbacks.create)},getElapsed:function(){return this.count*this.interval},getElapsedTime:function(){return new Date(this.time+this.getElapsed())},reset:function(a){clearInterval(this.timer);this.count=0;a&&this._setInterval(a);
this.callback(this.callbacks.reset)},start:function(a,b){this.factory.running=!0;this._createTimer(a);b||this.callback(this.callbacks.start)},stop:function(a,b){this.factory.running=!1;this._clearInterval(a);b||this.callback(this.callbacks.stop);this.callback(a)},_clearInterval:function(){clearInterval(this.timer)},_createTimer:function(a){this._setInterval(a)},_destroyTimer:function(a){this._clearInterval();this.timer=!1;this.callback(a);this.callback(this.callbacks.destroy)},_interval:function(a){this.callback(this.callbacks.interval);
...
b=this.factory.$el.find("ul"),d=this.factory.getTime().digitize([this.factory.getTime().time]);d.length>b.length&&c.each(d,function(b,c){a.createList(c).select(c)});c.each(this.lists,function(a,b){b.play()});this.base()},flip:function(a,b){this.shouldAutoIncrement&&this.autoIncrement();a||(a=this.factory.getTime().digitize([this.factory.getTime().time]));this.base(a,b)},reset:function(){var a=this.factory.original?Math.round(this.factory.original):0;this.factory.time=new FlipClock.Time(this.factory,
a);this.flip(!1,!1);this.factory.time.time=a}})})(jQuery);
...
6+e].$el);c(this.createDivider("Days",!0)).insertBefore(this.lists[0].$el);this.base()},flip:function(a,b){a||(a=this.factory.time.getDayCounter(this.showSeconds));this.autoIncrement();this.base(a,b)}})})(jQuery);
(function(c){FlipClock.HourlyCounterFace=FlipClock.Face.extend({constructor:function(a,b){this.base(a,b)},build:function(a,b){var d=this,e=this.factory.$el.find("ul");b=b?b:this.factory.time.getHourCounter();b.length>e.length&&c.each(b,function(a,b){d.createList(b)});c(this.createDivider("Seconds")).insertBefore(this.lists[this.lists.length-2].$el);c(this.createDivider("Minutes")).insertBefore(this.lists[this.lists.length-4].$el);a||c(this.createDivider("Hours",!0)).insertBefore(this.lists[0].$el);
...
(function(c){FlipClock.Lang.Spanish={years:"A\u00f1os",months:"Meses",days:"D\u00edas",hours:"Horas",minutes:"Minutos",seconds:"Segundos"};FlipClock.Lang.es=FlipClock.Lang.Spanish;FlipClock.Lang["es-es"]=FlipClock.Lang.Spanish;FlipClock.Lang.spanish=FlipClock.Lang.Spanish})(jQuery);
...
(function(c){FlipClock.Lang.Chinese={years:"\u5e74",months:"\u6708",days:"\u65e5",hours:"\u65f6",minutes:"\u5206",seconds:"\u79d2"};FlipClock.Lang.zh=FlipClock.Lang.Chinese;FlipClock.Lang["zh-cn"]=FlipClock.Lang.Chinese;FlipClock.Lang.chinese=FlipClock.Lang.Chinese})(jQuery);