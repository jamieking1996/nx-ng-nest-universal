...
define('theme/adapt-lmw/js/vanilla',['require','coreJS/adapt','backbone','theme/adapt-contrib-vanilla/js/theme-block'],function(require) {
...
;
define("plugins", ["components/adapt-contrib-graphic/js/adapt-contrib-graphic","components/adapt-contrib-narrative/js/adapt-contrib-narrative","components/adapt-contrib-text/js/adapt-contrib-text","components/adapt-lmw-activity/js/adapt-lmw-activity","components/adapt-lmw-photostory/js/adapt-lmw-photostory","extensions/adapt-contrib-assessment/js/adapt-assessmentArticleExtension","extensions/adapt-contrib-bookmarking/js/adapt-contrib-bookmarking","extensions/adapt-contrib-pageLevelProgress/js/adapt-contrib-pageLevelProgress","extensions/adapt-contrib-spoor/js/adapt-contrib-spoor","extensions/adapt-contrib-trickle/js/adapt-contrib-trickle","extensions/adapt-contrib-tutor/js/adapt-contrib-tutor","extensions/adapt-lmw-mobileFixes/js/adapt-lmw-mobileFixes","extensions/adapt-lmw-publishing/js/adapt-lmw-publishing","extensions/adapt-lmw-speech/js/adapt-lmw-speech","menu/adapt-contrib-boxMenu/js/adapt-contrib-boxmenu","theme/adapt-lmw/js/vanilla"], function(){});
